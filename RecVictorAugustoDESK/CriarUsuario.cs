...
namespace RecVictorAugustoDESK
{
    ...
    { // CONEXÃO COM O BANCO DE DADOS
        SqlConnection conn = new SqlConnection(@"workstation id=PortalVictor.mssql.somee.com;packet size=4096;user id=v917346_SQLLogin_1;pwd=2exxdybpol;data source=PortalVictor.mssql.somee.com;persist security info=False;initial catalog=PortalVictor");
